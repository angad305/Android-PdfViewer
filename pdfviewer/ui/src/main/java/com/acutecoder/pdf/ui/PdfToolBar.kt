...
open class PdfToolBar @JvmOverloads constructor(
    ...
    private val back: ImageView = root.findViewById(R.id.back)
    private val title: TextView = root.findViewById(R.id.title)
    private val find: ImageView = root.findViewById(R.id.find)
    private val more: ImageView = root.findViewById(R.id.more)
    private val findBar: LinearLayout = root.findViewById(R.id.findBar)
    private val findEditText: EditText = root.findViewById(R.id.findEditText)
    private val findProgressBar: ProgressBar = root.findViewById(R.id.findProgressBar)
    private val findInfo: TextView = root.findViewById(R.id.findInfo)
    private val findPrevious: ImageView = root.findViewById(R.id.findPrevious)
    private val findNext: ImageView = root.findViewById(R.id.findNext)
